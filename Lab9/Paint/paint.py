...
for i in range(0, 8, 2):
  buttons.add(Button(0, (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)), 820, 610 + i/2*110))
  buttons.add(Button(0, (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)), 910, 610 + i/2*110))
    ...
    if f == 1:
      ...
      if event.type == pg.MOUSEBUTTONUP:
        ...
        if prev:     
          ...
          pg.draw.polygon(screen, c, [(prev[0], prev[1]), (prev[0] + a, prev[1] - (prev[1] - cur[1])), (prev[0] + 2*a, prev[1])], 2)
          prev = cur
    elif f == 8:
      if event.type == pg.MOUSEBUTTONUP:
        cur = pg.mouse.get_pos()
